    ...
    render() {
        return (
            <div className='container'>
                <div id="carouselBanner" className="carousel slide" data-bs-ride="true">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src={nurseXpress} className="d-block w-100" alt="..."/>
                        </div>
                        <div className="carousel-item">
                            <img src={devsFunBlog} className="d-block w-100" alt="..."/>
                        </div>
                        <div className="carousel-item">
                            <img src={scurePassword} className="d-block w-100" alt="..."/>
                        </div>
                    </div>
